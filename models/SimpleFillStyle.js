...
// 
//  Name:            SimpleFillStyle [/models]
//  Original coding: Vasilis Vlastaras (@gisvlasta), 25/04/2016.
// 
//  Description:     Used for Rectangles and Circles styling.
// ================================================================================
...
// Create the SimpleFillStyle.
var SimpleFillStyle = new keystone.List('SimpleFillStyle', {
  map: { name: 'name' },
...
SimpleFillStyle.add({
  ...
  // The name of the SimpleFillStyle.
  name: { type: String, required: true },
  
  // The description of the SimpleFillStyle.
...
// Register the model.
SimpleFillStyle.defaultColumns = 'name, description|20%, definition.stroke, definition.color, definition.weight, definition.opacity, definition.fill, definition.fillColor, definition.fillOpacity';
SimpleFillStyle.register();
