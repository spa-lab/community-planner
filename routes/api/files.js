...
exports.list = function(req, res) {
  ...
  File.model.find(function(error, items) {
...
/**
 * List File ids. [ /api/file-ids ]
 */
exports.getids = function(req, res) {
  
  File.model.find({}, 'slug', function(error, items) {
...
/**
 * List File names. [ /api/file-names ]
 */
exports.getnames = function(req, res) {
  File.model.find({}, 'slug name description', function(error, items) {
...
/**
 * Get File by id. [ /api/file-getbyid/:id ]
 */
exports.getbyid = function(req, res) {
  
  File.model.findOne({ '_id': req.params.id }, 'slug name description addedDateTime url extension user', function (error, item) {
...
/**
 * Get File by slug. [ /api/file-getbyslug/:slug ]
 */
exports.getbyslug = function(req, res) {
  
  File.model.findOne({ 'slug': req.params.slug }, 'slug name description addedDateTime url extension user', function (error, item) {
